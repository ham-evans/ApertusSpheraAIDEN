...
contract AnimusRegnumArtifacts is Delegated, ERC1155MetaTx, PaymentSplitterMod{
  struct Token{
    uint burnPrice;
    uint mintPrice;
    uint balance;
  ...
  /** BEGIN: OS required **/
  string public name = "Animus Regnum: Artifacts";
  string public symbol = "AR:A";
  ...
  address[] private payees = [
    ...
    0xb701967e076E2BBb749C22DB4fA39747B62Dae59,
  ...
  constructor()
    Delegated()
    ERC1155MetaTx(name, "")
    PaymentSplitterMod( payees, splits ){
  }
  ...
  /** BEGIN: OS required **/
  //external
  function create( address initialOwner, uint supply, string calldata uri_ )
  ...
  //internal
  function _msgSender() internal virtual override(Context,ERC1155MetaTx) view returns (address sender){
